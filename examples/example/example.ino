...
CRGB leds[NUM_LEDS];
CFastLED FastObj;       // Create FastLED object, then pass to Subeffect's library

SubEffects effect( 0, DATA_PIN, NUM_LEDS, FastObj, leds);         // effect( subwoofer analog pin , Led's data pin, Led count, FastLED object, LED ARRAY)
